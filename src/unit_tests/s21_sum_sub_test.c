...
START_TEST(test_1_n) {
  ...
  ck_assert_int_eq(s21_sum_matrix(&m1, &m2, &res), EXIT_CALC_ERROR);
...
START_TEST(test_2_n) {
  ...
  ck_assert_int_eq(s21_sum_matrix(&m1, &m2, &res), EXIT_INCORRECT_MATRIX_ERROR);
...
START_TEST(test_3_n) {
  ...
  ck_assert_int_eq(s21_sum_matrix(&m1, NULL, &res),
...
START_TEST(test_1_n_) {
  ...
  ck_assert_int_eq(s21_sub_matrix(&m1, &m2, &res), EXIT_CALC_ERROR);
...
START_TEST(test_2_n_) {
  ...
  ck_assert_int_eq(s21_sub_matrix(&m1, &m2, &res), EXIT_INCORRECT_MATRIX_ERROR);
...
START_TEST(test_3_n_) {
  ...
  ck_assert_int_eq(s21_sub_matrix(&m1, NULL, &res),
                   EXIT_INCORRECT_MATRIX_ERROR);
